    ...
    <script type="text/javascript">
        ...
        window.onload = function() {
            ...
            // Backend Settings
                    ...
                    upload_url: "UploadSCls?"
                            + "UPID=" + queryString("UPID") 
            ...
            function uploadStart1() {
                alert("UploadSCls?NPID=" +queryString("NPID") + "&DT=" +queryString("DT"));
                //this.setUseQueryString(true);
                this.setUploadURL("UploadSCls?NPID=" +queryString("NPID") 
                            + "&DT=" +queryString("DTREL")
                            + "&DT=" +queryString("RELNO"));
                //this.addPostParam("NPID, "  + queryString("NPID"));
                //this.addPostParam("DT", queryString("DT"));

               //alert(queryString("NPID"));
                //alert(queryString("DT"));
            }
        };
    </script>
    </head>
